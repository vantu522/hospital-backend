  ...
  definition: {
    ...
    paths: {
      '/api/loai-kham': {
                ...
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      ...
                      data: {
                        type: 'array',
                        items: { $ref: '#/components/schemas/LoaiKham' }
                      },
                      pagination: {
                        type: 'object',
                        properties: {
        ...
        post: {
          ...
          requestBody: {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/LoaiKham' }
              }
            }
          },
          responses: {
              ...
              content: {
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      success: { type: 'boolean', example: true },
                      data: { $ref: '#/components/schemas/LoaiKham' },
                      message: { type: 'string', example: 'Tạo loại khám thành công' }
                    }
                  }
                }
              }
                ...
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      success: { type: 'boolean', example: true },
                      data: { $ref: '#/components/schemas/LoaiKham' },
                      message: { type: 'string', example: 'Cập nhật loại khám thành công' }
                    }
                  }
                }
              }
                ...
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      success: { type: 'boolean', example: true },
                      data: { $ref: '#/components/schemas/LoaiKham' },
                      message: { type: 'string', example: 'Xóa loại khám thành công' }
                    }
                  }
                }
              }
                ...
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      success: { type: 'boolean', example: true },
                      data: { $ref: '#/components/schemas/LoaiKham' },
                      message: { type: 'string', example: 'Khôi phục loại khám thành công' }
                    }
                  }
                }
              }
      ...
      '/api/khoa-kham': {
                ...
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      ...
                      data: {
                        type: 'array',
                        items: { $ref: '#/components/schemas/KhoaKham' }
                      },
                      pagination: {
                        type: 'object',
                        properties: {
        ...
        post: {
          ...
          requestBody: {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/KhoaKham' }
              }
            }
          },
          responses: {
              ...
              content: {
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      success: { type: 'boolean', example: true },
                      data: { $ref: '#/components/schemas/KhoaKham' },
                      message: { type: 'string', example: 'Tạo khoa khám thành công' }
                    }
                  }
                }
              }
                ...
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      success: { type: 'boolean', example: true },
                      data: { $ref: '#/components/schemas/KhoaKham' },
                      message: { type: 'string', example: 'Cập nhật khoa khám thành công' }
                    }
                  }
                }
              }
                ...
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      success: { type: 'boolean', example: true },
                      data: { $ref: '#/components/schemas/KhoaKham' },
                      message: { type: 'string', example: 'Xóa khoa khám thành công' }
                    }
                  }
                }
              }
                ...
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      success: { type: 'boolean', example: true },
                      data: { $ref: '#/components/schemas/KhoaKham' },
                      message: { type: 'string', example: 'Khôi phục khoa khám thành công' }
                    }
                  }
                }
              }
      ...
      '/api/phong-kham': {
                ...
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      ...
                      data: {
                        type: 'array',
                        items: { $ref: '#/components/schemas/PhongKham' }
                      },
                      pagination: {
                        type: 'object',
                        properties: {
        ...
        post: {
          ...
          requestBody: {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/PhongKham' }
              }
            }
          },
          responses: {
              ...
              content: {
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      success: { type: 'boolean', example: true },
                      data: { $ref: '#/components/schemas/PhongKham' },
                      message: { type: 'string', example: 'Tạo phòng khám thành công' }
                    }
                  }
                }
              }
                ...
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      success: { type: 'boolean', example: true },
                      data: { $ref: '#/components/schemas/PhongKham' },
                      message: { type: 'string', example: 'Cập nhật phòng khám thành công' }
                    }
                  }
                }
              }
                ...
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      success: { type: 'boolean', example: true },
                      data: { $ref: '#/components/schemas/PhongKham' },
                      message: { type: 'string', example: 'Xóa phòng khám thành công' }
                    }
                  }
                }
              }
                ...
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      success: { type: 'boolean', example: true },
                      data: { $ref: '#/components/schemas/PhongKham' },
                      message: { type: 'string', example: 'Khôi phục phòng khám thành công' }
                    }
                  }
                }
              }
      ...
      '/api/cong-kham': {
        get: {
          tags: ['CongKham'],
          summary: 'Lấy danh sách cổng khám',
          parameters: [
            {
              name: 'page',
              in: 'query',
                ...
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      ...
                      data: {
                        type: 'array',
                        items: { $ref: '#/components/schemas/CongKham' }
                      },
                      pagination: {
                        type: 'object',
                        properties: {
        ...
        post: {
          tags: ['CongKham'],
          summary: 'Tạo cổng khám mới',
          security: [{ bearerAuth: [] }],
          requestBody: {
            required: true,
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/CongKham' }
              }
            }
          },
          responses: {
              ...
              content: {
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      success: { type: 'boolean', example: true },
                      data: { $ref: '#/components/schemas/CongKham' },
                      message: { type: 'string', example: 'Tạo cổng khám thành công' }
                    }
                  }
                }
              }
                ...
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      success: { type: 'boolean', example: true },
                      data: { $ref: '#/components/schemas/CongKham' },
                      message: { type: 'string', example: 'Cập nhật cổng khám thành công' }
                    }
                  }
                }
              }
                ...
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      success: { type: 'boolean', example: true },
                      data: { $ref: '#/components/schemas/CongKham' },
                      message: { type: 'string', example: 'Xóa cổng khám thành công' }
                    }
                  }
                }
              }
                ...
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      success: { type: 'boolean', example: true },
                      data: { $ref: '#/components/schemas/CongKham' },
                      message: { type: 'string', example: 'Khôi phục cổng khám thành công' }
                    }
                  }
                }
              }
              ...
              content: {
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      success: { type: 'boolean', example: true },
                      message: { type: 'string', example: 'Import KhoaKham thành công' },
                      data: {
                        type: 'object',
                        properties: {
              ...
              content: {
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      success: { type: 'boolean', example: true },
                      message: { type: 'string', example: 'Import PhongKham thành công' },
                      data: {
                        type: 'object',
                        properties: {
                          totalImported: { type: 'integer' },
