...
doctorRouter.post('/', requireAdminOrSuperadmin, upload.fields([
...
doctorRouter.put('/:id', requireAdminOrSuperadmin, upload.fields([
    { name: 'avatar', maxCount: 1 }
]), doctorController.updateDoctor);
doctorRouter.delete('/:id', requireAdminOrSuperadmin, doctorController.deleteDoctor);
